...
namespace PhyGen.API.Controllers
{
    ...
    public class ContentItemExamCategoryController : BaseController<ContentItemExamCategoryController>
    {
        ...
        public async Task<IActionResult> GetContentItemExamCategoryById(int contentItemExamCategoryId)
        {
        ...
        [HttpGet]
        [ProducesResponseType(typeof(ApiResponse<ContentItemExamCategoryResponse>), (int)HttpStatusCode.OK)]
        public async Task<IActionResult> GetContentItemExamCategoryByContentItemIdAndExamCategoryId([FromQuery] Guid contentItemId, [FromQuery] int examCategoryId)
        {
        ...
        public async Task<IActionResult> CreateContentItemExamCategory([FromBody] CreateContentItemExamCategoryRequest request)
        {
            ...
            return await ExecuteAsync<CreateContentItemExamCategoryCommand, int>(command);
        }
