...
namespace PhyGen.API.Controllers
{
    ...
    public class ContentItemController : BaseController<ContentItemController>
    {
        ...
        {
            var request = new GetAllContentItemsQuery();
            return await ExecuteAsync<GetAllContentItemsQuery, List<ContentItemResponse>>(request);
        }
        ...
        public async Task<IActionResult> CreateContentItem([FromBody] CreateContentItemRequest request)
        {
            ...
            return await ExecuteAsync<CreateContentItemCommand, Guid>(command);
        }
