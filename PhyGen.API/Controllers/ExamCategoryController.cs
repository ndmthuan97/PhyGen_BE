...
namespace PhyGen.API.Controllers
{
    ...
    public class ExamCategoryController : BaseController<ExamCategoryController>
    {
        ...
        public async Task<IActionResult> GetExamCategoryById(int examCategoryId)
        {
        ...
        public async Task<IActionResult> CreateExamCategory([FromBody] CreateExamCategoryRequest request)
        {
            ...
            return await ExecuteAsync<CreateExamCategoryCommand, int>(command);
        }

        [HttpPut("{examCategoryId}")]
        [ProducesResponseType(typeof(ApiResponse<Unit>), (int)HttpStatusCode.OK)]
        public async Task<IActionResult> UpdateExamCategory(int examCategoryId, [FromBody] UpdateExamCategoryRequest request)
        {
            if (request == null)
            {
                return BadRequest(new ApiResponse<object>
